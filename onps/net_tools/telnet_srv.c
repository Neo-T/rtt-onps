...
{
    EN_ONPSERR enErr;
    SOCKET hSrvSocket = tcpsrv_start(AF_INET, TELNETSRV_PORT, ONPS_NVTNUM_MAX, TCPSRVRCVMODE_ACTIVE, &enErr);

#if defined(ONPS_ENABLE_IPV6) && defined(ONPS_ENABLE_TELNETSRV_IPV6)
    ...
    SOCKET hSrvSocket6 = tcpsrv_start(AF_INET6, TELNETSRV_PORT, ONPS_NVTNUM_MAX, TCPSRVRCVMODE_ACTIVE, &enErr);
...
#endif //* #if defined(ONPS_ENABLE_IPV6) && defined(ONPS_ENABLE_TELNETSRV_IPV6)
